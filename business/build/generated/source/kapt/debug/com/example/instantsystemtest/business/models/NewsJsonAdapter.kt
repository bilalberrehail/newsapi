...
public class NewsJsonAdapter(
  ...
  public override fun toString(): String = buildString(26) {
      append("GeneratedJsonAdapter(").append("News").append(')') }

  public override fun fromJson(reader: JsonReader): News {
  ...
  public override fun toJson(writer: JsonWriter, value_: News?): Unit {
    if (value_ == null) {
